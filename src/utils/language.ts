const lang = (langauge: string) => {
  if (langauge === 'en') {
    return {
      ...
      getOnboard: 'Get onboard and have access to unlimited possibilities.',
    ...
    return {
      input_location_label: "Choisissez l'emplacement de votre entreprise",
      bvn_input_prompt:
    ...
    return {
      ...
      getOnboard: 'Junte-se a nós e tenha acesso a possibilidades ilimitadas.',
